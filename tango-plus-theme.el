...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(message-header-to              ((,class (:inherit default))))
   `(message-header-cc              ((,class (:inherit default))))
   `(message-mml                    ((,class (:inherit deemphasized))))
   `(message-header-subject         ((,class (:inherit default :weight bold))))
   ...
   `(org-todo                       ((,class (:foreground ,red-3 :weight bold))))
   `(org-done                       ((,class (:foreground ,cham-3 :weight bold))))
   `(org-blocked                    ((,class (:foreground ,orange-3))))
   ...
   `(org-block-begin-line           ((,class (:foreground ,alum-4 :background ,alum-1 :extend t))))
   `(org-block                      ((,class (:background ,alum-1 :extend t))))
   `(org-block-end-line             ((,class (:foreground ,alum-4 :background ,alum-1 :extend t))))
   `(org-hide                       ((,class (:foreground ,white))))
   `(org-agenda-date                ((,class (:inherit org-level-2))))
   `(org-agenda-date-today          ((,class (:inherit org-agenda-date :weight bold))))
   `(org-agenda-date-weekend        ((,class (:inherit org-agenda-date))))
   `(org-agenda-current-time        ((,class (:foreground ,cham-2 :slant italic))))
   `(org-agenda-done                ((,class (:inherit deemphasized))))
